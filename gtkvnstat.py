...
BINDIR = HOMEDIR + "/gtkvnstat/" # <<< SET The path where gtkvnstat.py and gtkvnstat.glade stands
...
class GTKvnstatIndicator(object):
    def __init__(self):
        ...
        self.ind.set_attention_icon (BINDIR + "sad.png")
        #self.ind.set_icon("/home/manos/Desktop/gtkvnstat-app/happy.svg")
        self.ind.set_icon(BINDIR + "happy.svg")
